		...
		<div class="productOptions">
			...
			<div ng-hide="productDetail.PRODUCT.SHIPDETAILS.CANPICKUP">
				<div ng-hide="productDetail.PRODUCT.SHIPDETAILS.CANSHIP">
					<div ng-hide="productDetail.PRODUCT.SHIPDETAILS.CANDOWNLOAD">
						<p>Shipping: Not Available | Call For Rates</p>
					</div>
				</div>
			</div>

			<p>Product ID: {{productDetail.PRODUCT.SKU}} | Added: {{productDetail.PRODUCT.DATEADDED}}</p>
